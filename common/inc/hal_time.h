 ...
 *
 * The time value returned as 64-bit unsigned integer should represent the millisecond
 *
 * \return the monotonic time with millisecond resolution.
 */
PAL_API nsSinceEpoch
Hal_getMonotonicTimeInMs(void);

/**
 * Get the start value monotonic time in milliseconds.
 *
 * The time value returned as 64-bit unsigned integer should represent the millisecond
 *
 * \return the start value monotonic time with millisecond resolution.
 */
PAL_API nsSinceEpoch
Hal_getMonotonicStartTimeInMs(void);

            ...
            <Routes>
                ...
                <Route
                    ...
                    element={
                        <RequireAuth>
                            <MainLayout ability={props.ability}>
                                <Settings ability={props.ability} />
                            </MainLayout>
                        </RequireAuth>
                    }
                />
                <Route
                    ...
                    element={
                        <RequireAuth>
                            <MainLayout ability={props.ability}>
                                <UserSettingsEdit ability={props.ability} />
                            </MainLayout>
                        </RequireAuth>
                    }
                />
                ...
                <Route
                    ...
                    element={
                        <RequireAuth>
                            <MainLayout ability={props.ability}>
                                <ServerSettingsEdit ability={props.ability} />
                            </MainLayout>
                        </RequireAuth>
                    }
                />

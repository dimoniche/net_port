    ...
    return (
        <Grid container spacing={1}>
            ...
            >
                ...
                <TableCell align="right">{<a href={arm_linux_gnueabihf} download="module_net_port_client-0.0.1"> module_net_port_client-0.0.1 </a>}</TableCell>
            </StyledTableRow>
            <StyledTableRow
                sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
            >
            ...
            >
                ...
                <TableCell align="right">{<a href={x64_arm_linux} download="module_net_port_client-0.0.1"> module_net_port_client-0.0.1 </a>}</TableCell>
            </StyledTableRow>
            </TableBody>
            </Table>
            </TableContainer>
